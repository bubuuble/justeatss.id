        ...
        <div className="flex min-h-screen bg-black">
             ...
             <div className="hidden md:flex md:w-1/2 bg-zinc-900 flex-col justify-center items-center p-8 relative">
                 <div className="max-w-md text-center">
                     ...
                     <h2 className="text-3xl font-bold text-white mb-4">Join Justeatss.id</h2>
                     <p className="text-zinc-400 mb-6">Sign up to create your account and start exploring our delicious selection of sweet and savory treats.</p>
                 </div>
             </div>
             {/* Right side */}
